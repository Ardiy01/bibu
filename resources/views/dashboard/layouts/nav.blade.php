    ...
    <div class="position-sticky">
        <div class="container-fluid mb-5 mt-3">
            <a class="navbar-brand" href="/dashboard">
                <img src="{{ asset('assets/img/Logo.png') }}" alt="logo bibu" width="28" height="28" class="d-inline-block align-text-top">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/produk*') ? 'active shadow' : ''}}" href="/dashboard/produk">
                    <span class="iconify" data-icon="carbon:product"></span>
                    Produk
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/pesanan*') ? 'active shadow' : ''}}" href="/dashboard/pesanan">
