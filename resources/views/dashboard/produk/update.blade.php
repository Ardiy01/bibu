  ...
  <div class="container my-3">
      <div class="card shadow sty-card">
          ...
          <div class="card-body mt-0 mx-sm-5 mx-1">
              <form action="/dashboard/produk/{{ $produk->id }}" method="post" id="updateProduk" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                />  
                  ...
                  <x-input class="mb-3 fw-bold up-file"
                      id="gambar"
                      label="Gambar Produk"
                      type="file"
                      name="gambar"
                  ...
                  <div class="mb-3">
                    ...
                    <div class="d-grid gap-2 mt-4">
                      <button type="button" class="btn  fw-bold text-light shadow-sm" id="btn-update-produk" style="background-color: #004347">Simpan</button>
